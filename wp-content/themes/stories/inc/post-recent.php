...
class WP_Widget_Post_Last extends WP_Widget {
    ...
    private $_caching_name = 'hoatv_last_post_caching';

    // Constructor
    function __construct() {
        $id_base = 'recentpost';
        $name = 'Recent Post with Thumnail';
        $widget_options = array(
            'classname' => 'hoatv-wg-css-postrecent',
    ...
    function widget($args, $instance) {
        ...
        if ($caching == false) {
            ...
            set_transient($this->_caching_name, $recent_posts, 3 * MINUTE_IN_SECONDS);
        } else {
            $recent_posts = $caching;
