...
function lotus_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('lotus_js', get_template_directory_uri() . '/js/scripts.js', array('jquery'), '1.0.0', true);
        wp_enqueue_script('lotus_js');
    }
}
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Widget Blog', 'html5blank'),
        'description' => __('Widget of site', 'html5blank'),
        'id' => 'widget-main',
